    ...
    >
      <Header isNavOpen={isNavOpen} onToggleNav={() => setIsNavOpen(!isNavOpen)} />
        <Box sx={{ display: "flex", flexDirection: "row", height: "100%" }}>
          ...
          <Box mt={8} ml={isMobileWidth ? 0 : isNavOpen ? "248px" : "72px"} py={isMobileWidth ? 1 : 4} px={isMobileWidth ? 2 : 6} width="100%" height="max-content" sx={{ transition: "margin-left 0.3s",}}>
